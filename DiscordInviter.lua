...
local UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/max2007killer/III-LIBRARY/main/UI.lua"))()
local Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/max2007killer/III-LIBRARY/main/Directory.lua"))()
